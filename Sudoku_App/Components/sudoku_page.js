...
const styles = StyleSheet.create({
  ...
  cell1 : {height :36, width : 36, borderWidth : 1,textAlign :'center'},
  cell : {height :36, width : 36,borderWidth : 1, alignItems : 'center',},
  cell_index1 : {height :36, width : 36,borderBottomWidth: 1,borderRightWidth:1,borderLeftWidth : 2,textAlign :'center',borderColor : "#6A5ACD",},
  cell_index11 : {height :36, width : 36,borderBottomWidth: 1,borderRightWidth:1,alignItems : 'center',borderLeftWidth : 2,borderColor : "#6A5ACD",},
  cell_index10 : {height :36, width : 36,borderBottomWidth: 1,borderRightWidth:1,borderLeftWidth : 2,borderTopWidth:2,textAlign :'center',borderColor : "#6A5ACD",},
  cell_index101 : {height :36, width : 36,borderBottomWidth: 1,borderRightWidth:1,alignItems : 'center',borderTopWidth:2,borderLeftWidth : 2,borderColor : "#6A5ACD",},
  cell_index12 : {height :36, width : 36,borderLeftWidth : 2,borderRightWidth:1,borderBottomWidth:2,textAlign :'center',borderColor : "#6A5ACD",},
  cell_index102 : {height :36, width : 36,alignItems : 'center',borderRightWidth:1,borderBottomWidth: 2,borderColor : "#6A5ACD",borderLeftWidth : 2,},
  cell_index0 : {height :36, width : 36,borderBottomWidth:1,borderRightWidth:1,borderLeftWidth:2,textAlign :'center',borderColor : "#6A5ACD",},
  cell_index00 : {height :36, width : 36,borderBottomWidth:1,borderRightWidth:1,borderLeftWidth:2,alignItems : 'center',borderColor : "#6A5ACD",},
  cell_index_0 : {height :36, width : 36,borderTopWidth: 2,borderRightWidth:1,borderBottomWidth: 1,textAlign :'center',borderColor : "#6A5ACD",},
  cell_index_00 : {height :36, width : 36,borderTopWidth:2,borderRightWidth:1,borderBottomWidth: 1,alignItems : 'center',borderColor : "#6A5ACD",},
  cell_index_12 : {height :36, width : 36,borderBottomWidth: 2,borderRightWidth:1,textAlign :'center',borderColor : "#6A5ACD",},
  cell_index_102 : {height :36, width : 36,borderBottomWidth:2,borderRightWidth:1,alignItems : 'center',borderColor : "#6A5ACD",},
  cell_index_13 : {height :36, width : 36,borderBottomWidth: 1,borderRightWidth:1,textAlign :'center',borderColor : "#6A5ACD",},
  cell_index_103 : {height :36, width : 36,borderBottomWidth:1,borderRightWidth:1,alignItems : 'center',borderColor : "#6A5ACD",},
  cell_index_20 : {height :36, width : 36,borderTopWidth: 2,borderRightWidth:1,borderBottomWidth: 1,borderRightWidth:2,textAlign :'center',borderColor : "#6A5ACD",},
  cell_index_200 : {height :36, width : 36,borderTopWidth:2,borderRightWidth:1,borderBottomWidth: 1,borderRightWidth:2,alignItems : 'center',borderColor : "#6A5ACD",},
  cell_index_22 : {height :36, width : 36,borderBottomWidth: 2,borderRightWidth:1,borderRightWidth:2,textAlign :'center',borderColor : "#6A5ACD",},
  cell_index_222 : {height :36, width : 36,borderBottomWidth:2,borderRightWidth:1,borderRightWidth:2,alignItems : 'center',borderColor : "#6A5ACD",},
  cell_index_23 : {height :36, width : 36,borderBottomWidth: 1,borderRightWidth:1,borderRightWidth:2,textAlign :'center',borderColor : "#6A5ACD",},
  cell_index_223 : {height :36, width : 36,borderBottomWidth:1,borderRightWidth:1,borderRightWidth:2,alignItems : 'center',borderColor : "#6A5ACD",},
